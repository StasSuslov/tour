...
<form method="post" name="auth">
    ...
    <p>Введите пароль</p>
    <div>
        <input type="password" name="password" maxlength="255" value="" placeholder="Пароль" id="password" autofocus required>
    </div>
    <br>
<!--    <div>-->
...
<!--    <br>-->
    <div>
        <input type="submit" name="submit" id="sha" value="Вход">
    </div>
</form>
