...
<!--	<link rel="stylesheet" type="text/css" href="order_tour/view.css" media="all">-->
	<script type="text/javascript" src="order_tour/view.js"></script>
	<script type="text/javascript" src="order_tour/calendar.js"></script>
</head>
<body id="main_body" >
		...
		<form id="form_33804" class="appnitro"  method="post" action="order_processing.php">
			...
			<ul >
                ...
                <li id="li_1" >
                    ...
                    <div>
                        <input id="FIO" name="FIO" class="element text medium" type="text" maxlength="255" value=""/>
                    </div>
                </li>
                ...
                <li id="li_5" >
                    ...
                    <div>
                        <input id="num_persons" name="num_persons" class="element text medium" type="text" maxlength="255" value=""/>
                    </div>
                </li>
                ...
                <li id="li_6" >
                    ...
                    <span>
                        <input id="month_in" name="month_in" class="element text" size="2" maxlength="2" value="" type="text"> /
                        <label for="month_in">MM</label>
                    </span>
                    <span>
                        <input id="day_in" name="day_in" class="element text" size="2" maxlength="2" value="" type="text"> /
                        <label for="day_in">DD</label>
                    </span>
                    <span>
                        <input id="year_in" name="year_in" class="element text" size="4" maxlength="4" value="" type="text">
                ...
                <li id="li_7" >
                    ...
                    <span>
                        <input id="month_out" name="month_out" class="element text" size="2" maxlength="2" value="" type="text"> /
                        <label for="month_out">MM</label>
                    </span>
                    <span>
                        <input id="day_out" name="day_out" class="element text" size="2" maxlength="2" value="" type="text"> /
                        <label for="day_out">DD</label>
                    </span>
                    <span>
                        <input id="year_out" name="year_out" class="element text" size="4" maxlength="4" value="" type="text">
