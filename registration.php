...
if(isset($_POST['submit']))
{
    ...
    if(count($err) == 0)
    {
        ...
        $insert_sql = "INSERT INTO  users (user_id, user_login, user_password, user_hash, Name, Surname, Mail, Phone)" .
            "VALUES (NULL, '{$login}','{$password}', NULL, '{$name}','{$surname}','{$mail}','{$phone}');";
...
<form method="post" name="registration">
    ...
    <p>Введите пароль</p>
    <div>
        <input type="password" name="password" maxlength="255" value="" id="password1" placeholder="Пароль" autofocus required>
    </div>

    <p>Повторите пароль</p>
    <div>
        <input type="password" name="rep_password" maxlength="255" value="" id="password2" placeholder="Повторите пароль" autofocus required>
    </div>
    <br>
    <div>
        <input type="submit" name="submit" value="Зарегистрироваться" id="sha">
    </div>
</form>
</div>
...
<script type="text/javascript">
    ...
    document.getElementById('sha').onclick = function() {
        ...
        var txt_string = document.getElementById('password1').value;      // gets data from input text
// encrypts data and adds it in #strcrypt element
        document.getElementById('password1').value = SHA256(txt_string);

        var txt_string2 = document.getElementById('password2').value;      // gets data from input text

// encrypts data and adds it in #strcrypt element
        document.getElementById('password2').value = SHA256(txt_string2);
        return header("Location: ?type=7");
    }
</script>